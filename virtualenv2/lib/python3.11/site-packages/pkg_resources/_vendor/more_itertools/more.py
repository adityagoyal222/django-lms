...
def minmax(iterable_or_value, *others, key=None, default=_marker):
    ...
    return lo, hi
<<<<<<< HEAD:virtualenv/lib/python3.10/site-packages/pkg_resources/_vendor/more_itertools/more.py
=======
...
def constrained_batches(
    ...
    *max_size*.
    ...
    if batch:
        yield tuple(batch)
>>>>>>> f9fa2e2acc8848cb42bf87b6881f3c51c171737e:virtualenv/lib/python3.11/site-packages/pkg_resources/_vendor/more_itertools/more.py
